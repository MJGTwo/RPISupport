    ...
    <div className="card" style={{ background: RED, paddingBottom: '20px' }}>
      <div className="card-content white-text">
        ...
        <p>
          ...
          assist the{' '}
          <a href="http://www.rpi.edu/dept/public_safety/emergency/index.html">
            management of critical incidents
          </a>
          , and conducts{' '}
          <a href="http://www.rpi.edu/dept/public_safety/safety/personal.html">
            {}awareness programs
          </a>{' '}
      ...
      <div className="card-action">
        <a href="http://www.rpi.edu/dept/public_safety/">Click for website</a>
      </div>
    </div>
  );
};
